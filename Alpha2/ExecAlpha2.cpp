...
{
	int i = (argc == 1) ? 1077 : _tstoi(argv[1]);
	...
	Double_t stops[NRGBs] = { 0.00, 0.05, 0.10, 0.25, 0.33, 0.45, 0.65, 1.00 };
	Double_t red[NRGBs]   = { 1.00, 0.71, 0.00, 0.00, 0.00, 0.87, 1.00, 0.51 };
	Double_t green[NRGBs] = { 1.00, 0.50, 0.00, 0.81, 1.00, 1.00, 0.20, 0.00 };
	Double_t blue[NRGBs]  = { 1.00, 0.86, 0.51, 1.00, 0.00, 0.12, 0.00, 0.00 };
