...
class RutherfordEnergy : public TSelector {
public :
   ...
   RutherfordEnergy(TTree * /*tree*/ =0) : h(400, 8000, 4096){ }
   virtual ~RutherfordEnergy() { }
...
inline void RutherfordEnergy::Init(TTree *tree)
{
